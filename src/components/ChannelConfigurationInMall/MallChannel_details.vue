  ...
  <div class="flex side_sdx ivuInput-box">
    ...
    <div class="H_t flex side_sdx mainAlign_center">
      <div>
        ...
        <router-link class="colorCCC blod" to="/MallChannelDetails">配置详情</router-link>
      </div>
    </div>
    <!-- 表单区域 -->
    <div class="list">
      <Form :model="supplierAddForm"  ref="supplierAddForm" :rules="supplierAddRules" :label-width="90">
        <Card style="width: 100%">
          ...
          <FormItem label="频道类型：" prop="returnAddress ">
                <span v-if="supplierAddForm.type=='0'">门店</span> 
                <span v-if="supplierAddForm.type=='1'">自营商品</span> 
          </FormItem>
...
<!--                 
            ...
            <div class="Enable">
                <FormItem label="发布设置：" prop="returnAddress ">
                  <!-- <RadioGroup v-model="verticals" @on-change="Channeltime">
                    ...
                    <span>{{verticals}}</span>
                    <DatePicker type="datetime" placeholder="请选择生效时间" disabled v-model="supplierAddForm.openTime" style="width: 200px" @on-change="onOpenTime(supplierAddForm.openTime)"></DatePicker>
              </FormItem>
            </div>
    ...
    <div class="hide flex sideAlign_center mainAlign_center" v-show="telshow">
        ...
        <div class="allcont">
          ...
          <Input placeholder="搜索门店/商品名称" style="width: auto">
