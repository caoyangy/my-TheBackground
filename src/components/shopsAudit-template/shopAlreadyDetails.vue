	...
	<div class="flex side_sdx wary">
		...
		<div class="H_t flex side_sdx mainAlign_center">
			...
			<div>
                ...
                &nbsp;&nbsp; /&nbsp;&nbsp; 
                <router-link class="colorCCC " to="/shopAlready">入驻商家</router-link> 
				&nbsp;&nbsp; /&nbsp;&nbsp; 
                <router-link class="colorCCC blod" to="/shopAlreadyDetails">详情</router-link>
            </div>
		</div>
		<!--tab切换-->
