	...
	<div>
		...
		<div class="H_t flex side_sdx mainAlign_center">
			...
			<div>
                ...
                <router-link  class="colorCCC blod" to="/shopManagement">课程管理</router-link>
            </div>
		</div>
                ...
                <div class=" shop_content_main_bottom ">
                    ...
                    <div v-for="( msg,index ) in couserList" :key="index" class="couser_name" @click="goPutCouser(msg)" >
                        <div class="couser_name_top">
                            <img :src="msg.coursePictureUrl[0]" alt="  ">
                        </div>
...
<script>
    ...
    export default {
		...
		methods: {
            ...
            page(e) {
                this.getAllCourse(this.shopId,this.searchTab,this.storagUuserid, this.storagToken,e);
            },
            ...
            getAllCourse : function ( shopid,stuta,userId,token,e) {
                if(e){
                    this.$API('post','productInfo/findProductsByStoreId',{
                        "storeId": shopid,
                        ...
                        for(var i=0;i<this.couserList.length;i++){
                            ...
                            this.couserList[i].coursePictureUrl = JSON.parse(res.data.data.list[i].coursePictureUrl)
                        }
